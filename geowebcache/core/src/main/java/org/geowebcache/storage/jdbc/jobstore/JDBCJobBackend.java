...
public class JDBCJobBackend implements JobStore {
    ...
    public JDBCJobBackend(String driverClass, String jdbcString, String username, String password, int maxConnections)
            throws ConfigurationException, StorageException {
     ...
     * @param memOnly
     *            Whether to run the job store in memory only
